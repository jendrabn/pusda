...
return [
	...
	| kelas validator. Beberapa aturan memiliki versi ganda seperti aturan ukuran.
	| Anda bebas mengubah pesan-pesan ini sesuai kebutuhan aplikasi Anda.
	|
	*/
	...
	'password' => [
		...
		'uncompromised' => 'Kolom :attribute telah bocor dalam kebocoran data. Harap pilih :attribute yang berbeda.',
	],
	...
	|--------------------------------------------------------------------------
	|
	| Anda bisa menentukan pesan validasi kustom untuk atribut menggunakan konvensi
	| "attribute.rule" untuk memberi nama baris. Ini memudahkan untuk menentukan
	| pesan kustom spesifik untuk aturan atribut tertentu.
	|
	*/
