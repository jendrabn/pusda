...
@section('content')
  ...
  <section class="section-body">
    ...
    <p class="section-lead">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Magnam porro illum omnis explicabo
      eveniet iusto?</p>
    ...
    <div class="card">
      <div class="card-header">
        <h4>Tambah Data Uraian Form "{{ $tabelBps->nama_menu }}"</h4>
        <div class="card-header-action">
      ...
      <div class="collapse show" id="uraian-form-card-collapse">
        <div class="card-body">
          <form action="{{ route('admin.uraian.bps.store') }}" method="POST">
            @csrf
