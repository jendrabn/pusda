      ...
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('admin.skpd.update', $skpd->id) }}">
          ...
          <div class="form-group">
            ...
            <select class="form-control @error('kategori_skpd_id') is-invalid @enderror" id="kategori_skpd_id" name="kategori_skpd_id" required autofocus>
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" type="text" value="{{ $skpd->nama }}" required>
            @error('nama')
            <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
          ...
          <div class="form-group">
            ...
            <input class="form-control @error('singkatan') is-invalid @enderror" id="singkatan" name="singkatan" type="text" value="{{ $skpd->singkatan }}" required>
            @error('singkatan')
            <span class="error invalid-feedback">{{ $message }}</span>
            @enderror
          </div>
