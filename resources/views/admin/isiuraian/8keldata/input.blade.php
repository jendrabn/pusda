            ...
            <div class="tab-content" id="tab-content">
              <div class="tab-pane fade show active" id="table" role="tabpanel" aria-labelledby="tabel-tab">
                <div class="d-flex justify-content-end align-items-center">
                  ...
                  @include('admin.isiuraian.partials.button_export', ['resource_name' => 'delapankeldata', 'table_id' =>
                  $tabel8KelData->id])
                </div>
...
@section('outer')
  ...
  => true ])
  @include('admin.isiuraian.partials.modal_file_upload', ['action' => route('admin.delapankeldata.files.store',
  $tabel8KelData->id)
  ])
  @include('admin.isiuraian.partials.modal_add_year', ['resource_name' => 'delapankeldata', 'tabel_id' =>
  $tabel8KelData->id])
@endsection
