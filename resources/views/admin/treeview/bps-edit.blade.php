...
@section('content')
  <section class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="{{ route('admin.treeview.bps.index') }}">Tree View BPS</a>
      </div>
      ...
      <div class="card-body">
        <form action="{{ route('admin.treeview.bps.update', $tabelBps->id) }}" method="POST">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" name="menu_name" class="form-control" value="{{ $tabelBps->menu_name }}">
            </div>
          </div>
          <div class="form-group row mb-4">
