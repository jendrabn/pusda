...
class TabelRpjmdDataTable extends DataTable
{
	/**
	 ...
	 */
	public function query(TabelRpjmd $model): QueryBuilder
	{
		return $model->newQuery()->with(['parent', 'skpd'])->select('tabel_rpjmd.*');
	}
	...
	{
		return 'TabelRpjmd_' . date('YmdHis');
	}
}
