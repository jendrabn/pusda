...
class TabelBpsDataTable extends DataTable
{
	/**
	 ...
	 */
	public function query(TabelBps $model): QueryBuilder
	{
		return $model->newQuery()->with(['parent'])->select('tabel_bps.*');
		;
	}
