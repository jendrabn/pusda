...
class TabelIndikatorDataTable extends DataTable
{
	/**
	 ...
	 */
	public function query(TabelIndikator $model): QueryBuilder
	{
		return $model->newQuery()->with(['parent'])->select('tabel_indikator.*');
	}
	...
	{
		return 'TabelIndikator_' . date('YmdHis');
	}
}
