...
class IndikatorController extends Controller
{
	...
	public function store(Request $request): RedirectResponse
	{
		...
		toastr()->addSuccess('Tabel Indikator berhasil disimpan.');
	...
	public function update(Request $request, TabelIndikator $tabel): RedirectResponse
	{
		...
		toastr()->addSuccess('Tabel Indikator berhasil diperbarui.');
	...
	public function destroy(TabelIndikator $tabel): RedirectResponse
	{
		...
		toastr()->addSuccess('Tabel Indikator berhasil dihapus.');
